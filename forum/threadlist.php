...
<?php include 'dbconnect.php'; ?>
    ...
    if($method == 'POST'){
        ...
        if($showAlert){
            ...
            <strong>Success!</strong> Your thread has been added! Please wait when someonefor comunity to respond.
    ...
    echo '<div class="container">
              ...
              <form action="'. $_SERVER["REQUEST_URI"].'" method="post">
                 <div class="mb-3">
                     ...
                     <small>Keep your title as short and crisp as possible</small>
                 </div>
     ...
     while($row = mysqli_fetch_assoc($result)){
       ...
       echo '<div class="media my-3">
            ...
            <div class="media-body">'.
                ...
                ' . $desc . 'at' . ' 
            </div>'.'<p class="my-0" style="font-weight: bold;"> Asked by: '. $row2['user_email'] . $thread_time .'</p>'
        .'</div>';
    }
    if($noResult){
        echo '<div class="jumbotron jumbotron-fluid">
                <div class="container">
                   ...
                   <p class="lead">Be the person to ask a question</p>
                </div>
            </div>';   
    }    
    ?>
